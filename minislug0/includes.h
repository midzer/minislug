...
struct SGene
{
	SDL_Surface *pScreen;	// Ptr sur le buffer �cran.
...
//	SDL_Rect	sBkgRect;			// Rect pour d�placer le blit.
	...
	struct SGIFFile	*pGif;			// Gif anim� (Pr�sentation).
...
//	u8	nScreenMode;		// 0 = Windowed / 1 = Full screen.
	s8	nCreditsToUse;		// Nb de cr�dits � utiliser dans la partie.
